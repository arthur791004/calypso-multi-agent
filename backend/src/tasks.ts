...
export async function injectTaskIntoClaudeMd(
  ...
  const section = [
    ...
    "## Sandbox rules",
    "",
    "- When the work is ready to share, run `shipyard:sandbox push` to push the branch and create/update its PR.",
    "- Do NOT use `git push` directly — pushes must go through the host.",
